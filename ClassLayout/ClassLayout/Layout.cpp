...
/////////////////////////////////////////////////////////////////////
// Base class holds string and displays its layout statistics

class Base
{
public:
  Base(const std::string& msg) : msg_(msg) 
  {
  ...
  { 
    std::cout << "\n\n  Base::say()";
    showStatistics(this);
    showString("Base", msg_);
  }
protected:
  std::string msg_;
};
/////////////////////////////////////////////////////////////////////
// Composed class is a data member of Derived, shows its statistics
...
/////////////////////////////////////////////////////////////////////
// Derived inherits from Base and composes Composed.
// Instances of both lie withing Deriveds footprint.

class Derived : public Base
{
public:
  Derived(const std::string& msg) : Base(msg), comp(msg)
  {
  ...
  virtual void say()
  {
    std::cout << "\n\n  Derived::say()";
    showStatistics(this);
    showString("Derived",msg_);

    std::cout << "\n\n  Derived calling Base::say(): ";
    Base::say();
    std::cout << "\n\n  Derived invoking my Composed::say(): ";
    comp.say();
    std::cout << std::endl;
  }
private:
